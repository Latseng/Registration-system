        ...
        <div>
          <div className="bg-white mb-6 p-3 rounded-lg">
            ...
            <div className="flex flex-wrap mb-6">
              <Button className="w-24 h-10 mr-4">一般內科</Button>
              <Button className="w-24 h-10 mr-4">心臟內科</Button>
              <Button className="w-24 h-10 mr-4">肝膽腸胃科</Button>
              <Button className="w-24 h-10 mr-4">腎臟科</Button>
            </div>
          </div>
          ...
          <div className="bg-white mb-6 p-3 rounded-lg">
            ...
            <div className="flex flex-wrap mb-6">
              <Button className="w-24 h-10 mr-4">一般外科</Button>
              <Button className="w-24 h-10 mr-4">骨科</Button>
            </div>
          </div>
          <div className="bg-white mb-6 p-3 rounded-lg">
            <h2 className="text-xl mb-4">其他</h2>
            <div className="flex flex-wrap mb-6">
              <Button className="w-24 h-10 mr-4">中醫</Button>
              <Button className="w-24 h-10 mr-4">眼科</Button>
              <Button className="w-24 h-10 mr-4">皮膚科</Button>
            </div>
          </div>
        </div>
      </Content>
